...
import { Users, Shield, UserX, Play, HelpCircle, Plus, Minus, Tag, Eye, ArrowLeft } from "lucide-react";
    ...
    <div className="glass-panel max-width-container animated-slide-in">
      <div className="setup-header" style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "20px" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
          ...
          <h1 className="gradient-text header-title" style={{ margin: 0 }}>Ai Là Gián Điệp?</h1>
        </div>
        <button
          type="button"
          onClick={() => {
