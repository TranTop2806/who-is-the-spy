...
const DYNAMIC_TEMPLATES: { type: DrinkingCard["type"]; content: string }[] = [
  ...
  { type: "INTERACTIVE", content: "{P1} hãy cõng {P2} đi một vòng quanh phòng hoặc uống {N} chén." },
  { type: "INTERACTIVE", content: "{P1} hãy mát xa vai cho {P2} trong 30 giây hoặc uống {N} hớp." },
  { type: "INTERACTIVE", content: "{P1} kể ra 3 tật xấu của {P2} mà bạn biết hoặc uống {N} hớp." },
  { type: "INTERACTIVE", content: "{P1} hãy nhìn thẳng vào mắt {P2} trong 15 giây mà không được cười, ai cười trước uống {N} hớp." },
  { type: "INTERACTIVE", content: "{P1} phải làm tóc cho {P2} theo kiểu kỳ dị nhất hoặc uống {N} hớp." },
  { type: "INTERACTIVE", content: "{P1} hãy nhảy đôi cùng {P2} trong 20 giây hoặc cả hai cùng uống {N} hớp." },
  { type: "INTERACTIVE", content: "{P1} và {P2} phải uống chéo chén rượu với nhau ngay lập tức!" },
  { type: "INTERACTIVE", content: "{P1} hãy hát tặng {P2} một câu hát có từ 'yêu' hoặc cả hai cùng uống {N} hớp." },
  { type: "INTERACTIVE", content: "{P1} hãy nhắn tin nói 'Tôi nhớ bạn' cho người đầu tiên trong danh bạ hiển thị, dưới sự giám sát của {P2}, từ chối uống {N} chén." },
  { type: "INTERACTIVE", content: "{P1} hãy đưa điện thoại cho {P2} chọn một bức ảnh bất kỳ trong album và đăng lên mạng xã hội hoặc {P1} uống {N} chén." },
  { type: "INTERACTIVE", content: "{P1} hãy thì thầm vào tai {P2} một bí mật thầm kín nhất hoặc uống {N} hớp." },
  { type: "INTERACTIVE", content: "{P1} kể ra điều bạn thấy ghét nhất ở {P2} hoặc uống {N} hớp." },
  { type: "INTERACTIVE", content: "{P1} hãy đổi chỗ ngồi với {P2} ngay lập tức, người di chuyển chậm hơn uống {N} hớp." },
  { type: "INTERACTIVE", content: "{P1} phải để {P2} vẽ một hình xăm bằng bút lên tay/cổ hoặc uống {N} chén." },
  { type: "INTERACTIVE", content: "{P1} hãy gọi điện cho mẹ/bố nói 'Con xin lỗi' rồi tắt máy dưới sự chứng kiến của {P2} hoặc uống {N} chén." },
  { type: "INTERACTIVE", content: "{P1} hãy nhắm mắt lại và đoán xem {P2} đang chạm vào bộ phận nào trên mặt bạn, đoán sai uống {N} hớp." },
  { type: "INTERACTIVE", content: "{P1} hãy mô tả {P2} bằng 3 tính từ hài hước nhất hoặc uống {N} hớp." },
  { type: "INTERACTIVE", content: "{P1} hãy kể lại ấn tượng đầu tiên của mình về {P2} một cách thật thà hoặc uống {N} hớp." },
  { type: "INTERACTIVE", content: "{P1} hãy nắm tay {P2} cho đến lượt tiếp theo của bạn, buông tay ra trước phạt {N} hớp." },
  { type: "INTERACTIVE", content: "{P1} hãy tự chọn một người phạt uống {N} hớp, người đó chọn {P2} uống {N} hớp." },
  { type: "INTERACTIVE", content: "{P1} hãy dùng chân viết tên {P2} lên không trung hoặc uống {N} hớp." },
  { type: "INTERACTIVE", content: "{P1} phải để {P2} kiểm tra lịch sử cuộc gọi gần nhất hoặc uống {N} hớp." },
  
  // Truths & Secrets
  { type: "INTERACTIVE", content: "{P1} hãy trả lời thật: Bạn đã từng có ý định tán tỉnh {P2} chưa? Không trả lời uống {N} chén." },
  { type: "INTERACTIVE", content: "{P1} hãy tiết lộ một bí mật mà bạn từng giấu {P2}. Không nói uống {N} chén." },
  { type: "INTERACTIVE", content: "{P1} nếu phải chọn kết hôn với {P2} hoặc {P3}, bạn sẽ chọn ai? Không chọn uống {N} hớp." },
  { type: "INTERACTIVE", content: "{P1} hãy cho biết ai là người bạn tin tưởng nhất giữa {P2} và {P3}. Người còn lại phạt uống {N} hớp." },
  { type: "INTERACTIVE", content: "{P1} hãy cho điểm ngoại hình của {P2} trên thang điểm 10 một cách thật lòng trước mặt họ hoặc uống {N} hớp." },
  { type: "INTERACTIVE", content: "{P1} nếu {P2} bị bắt cóc và đòi tiền chuộc, bạn có sẵn sàng bỏ tiền ra cứu không? Nói thật hoặc uống {N} hớp." },
  { type: "INTERACTIVE", content: "{P1} hãy kể một kỷ niệm đáng nhớ nhất của bạn với {P2} hoặc uống {N} hớp." },
  
  // Rules & Group
  { type: "INTERACTIVE", content: "{P1} và {P2} từ giờ không được dùng điện thoại, ai chạm vào trước uống {N} hớp." },
  { type: "INTERACTIVE", content: "{P1} và {P2} từ giờ trở thành 'bạn cùng tiến', mỗi khi {P1} uống thì {P2} phải uống theo và ngược lại." },
  { type: "INTERACTIVE", content: "Quy tắc nhóm: Mỗi khi {P1} nói, {P2} phải vỗ tay. Quên vỗ tay {P2} uống {N} hớp." },
  { type: "INTERACTIVE", content: "{P1} hãy chọn một từ cấm dành cho {P2}. Mỗi khi {P2} nói từ đó phải uống {N} hớp." },
  { type: "INTERACTIVE", content: "Tất cả mọi người oẳn tù tì với {P1}. Ai thua {P1} phải uống {N} hớp." },
  { type: "INTERACTIVE", content: "{P1} và {P2} phải đổi đồ uống cho nhau cho đến hết vòng chơi này." },
  
  // Votes & Decisions
  { type: "INTERACTIVE", content: "{P1} và {P2} ai lười biếng hơn? Cả nhóm biểu quyết, ai nhiều phiếu hơn uống {N} hớp." },
  { type: "INTERACTIVE", content: "{P1} và {P2} ai có nguy cơ ế lâu nhất? Cả nhóm biểu quyết, ai nhiều phiếu hơn uống {N} hớp." },
  { type: "INTERACTIVE", content: "{P1} và {P2} ai chi tiêu hoang phí hơn? Cả nhóm biểu quyết, người thắng uống {N} hớp." },
  { type: "INTERACTIVE", content: "{P1} hãy quyết định giữa {P2} và {P3} ai phải uống {N} hớp." },
  { type: "INTERACTIVE", content: "{P2} và {P3} oẳn tù tì, {P1} đoán xem ai thắng. Nếu {P1} đoán sai uống {N} hớp, đoán đúng cả hai người kia uống {N} hớp." }
];
